...
public class ApprovalHistoryService {
    ...
    @Transactional 
    public void createApprovalLine(Long creatorId, Long complainId,String url, List<ApprovalHistoryDTO> approvalLine) {
        ...
        for (int i = 0; i < approvalLine.size(); i++) {
            ...
            if (dto.getApproverTypeCd() == null || (!dto.getApproverTypeCd().equals("E01") && !dto.getApproverTypeCd().equals("E02"))) {
