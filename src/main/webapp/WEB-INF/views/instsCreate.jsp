									...
									<table class="table table-bordered table-sm kv-table">
										...
										<tbody>
											...
											<tr>
												...
												<td colspan="3"><input type="text" name="inst_name" id="inst_name" class="form-control form-control-sm" placeholder="공지 제목을 입력하세요" required maxlength="200"></td>
											</tr>

											<!-- 작성자 / 등록일 -->
											<tr>
												<th scope="col" class="text-dark bg-light font-weight-bold">대표자명</th>
												<td><input type="text" name="inst_head_name" id="inst_head_name" class="form-control form-control-sm" value="인사팀_정동윤" required></td>
												<th>기관 등록일</th>
