				...
				<div class="container-fluid mb-4">
					...
					<form id="loanApplyForm" method="post"
										...
										<tbody>
											<tr>
												...
												<td><input type="date" class="form-control"
													name="birthdate"></td>
												<th>영아의 주민등록번호</th>
												<td><input type="text" id="baby_resi_no_front"
													maxlength="6" inputmode="numeric" pattern="[0-9]*"
													placeholder="생년월일 6자리"
													style="width: 40%; display: inline-block;"> <span
													class="mx-1">-</span> <input type="text"
													id="baby_resi_no_back" maxlength="7" inputmode="numeric"
												...
												<td>
													<div class="form-check form-check-inline">
														<input class="form-check-input" type="radio"
															name="COHABIT_YN" id="COHABIT_Y"
															<c:if test="${dto.SUBSIDY_BENEFIT_YN eq 'Y'}">checked</c:if>>
														<label class="form-check-label" for="COHABIT_Y">예</label>
													</div>
													<div class="form-check form-check-inline ml-3">
														<input class="form-check-input" type="radio"
															name="COHABIT_YN" id="COHABIT_N"
															<c:if test="${dto.SUBSIDY_BENEFIT_YN ne 'Y'}">checked</c:if>>
														<label class="form-check-label" for="COHABIT_N">아니오</label>
													</div>
												</td>
												<th>친족여부</th>
												<td colspan="1"><label> <input class="ml-1"
														type="radio" name="RELATIONSHIP"> 배우자
												</label> <label> <input class="ml-1" type="radio"
														name="RELATIONSHIP"> 8촌이내 혈족
												</label> <label> <input class="ml-1" type="radio"
														name="RELATIONSHIP"> 4촌이내 인척
												</label><br> <label> <input class="ml-1" type="radio"
														name="RELATIONSHIP"> 해당없음
												</label></td>
											</tr>
										</tbody>
									</table>
										...
										<tbody>
											<tr>
												...
												<td><input type="text" class="form-control"
													name="BIZ_OWNER_NM"></td>
												<th>사업장의 고용보험관리번호</th>
												<td><input type="text" class="form-control"
													name="EMP_INSUR_MNG_NO"></td>
											</tr>
											<tr>
												...
												<td colspan="3">
													<div class="d-flex mb-2">
														<input type="text"
															...
															placeholder="우편번호" name="BIZ_POST" id="BIZ_POST" readonly
															style="width: 150px;">

														<button type="button" class="btn btn-secondary"
															onclick="openDaumPostcode()">주소 검색</button>
													</div> <input type="text" class="form-control mb-2"
													placeholder="기본 주소" name="BIZ_ADDR" id="BIZ_ADDR" readonly>
													<input type="text" class="form-control"
													placeholder="상세 주소 (건물명, 동/호수 등)" name="addr2" id="addr2">
												</td>
											</tr>
											<tr>
												<th>사업자등록번호</th>
											...
											<tr>
												...
												<td colspan="3">
													<div class="form-check form-check-inline">
														<input class="form-check-input" type="radio"
															name="SELF_EMP_INSUR_YN" id="SELF_EMP_INSUR_Y"
															<c:if test="${dto.SUBSIDY_BENEFIT_YN eq 'Y'}">checked</c:if>>
														<label class="form-check-label" for="SELF_EMP_INSUR_Y">가입</label>
													</div>
													<div class="form-check form-check-inline ml-3">
														<input class="form-check-input" type="radio"
															name="SELF_EMP_INSUR_YN" id="SELF_EMP_INSUR_N"
															<c:if test="${dto.SUBSIDY_BENEFIT_YN ne 'Y'}">checked</c:if>>
														<label class="form-check-label" for="SELF_EMP_INSUR_N">미가입</label>
													</div>
												</td>
											</tr>
										</tbody>
								...
								<div class="table-responsive">
									<table class="table table-bordered mb-0" style="width: 100%">
										...
										<tbody>
											<tr>
												<th>급여의 구분</th>
												<td colspan="6"><label> <input class="ml-6"
														type="radio" name="BENEFIT_TYPE"> 출산급여
												</label><br> <label> <input class="ml-6" type="radio"
														name="BENEFIT_TYPE"> 유산/사산급여 (임신기간 :
												</label> <label> <input class="ml-6" type="checkbox"
														name="PREGNANCY_WEEK"> 15주 이내
												</label> <label> <input class="ml-6" type="checkbox"
														name="PREGNANCY_WEEK"> 16~21주
												</label> <label> <input class="ml-6" type="checkbox"
														name="PREGNANCY_WEEK"> 22~27주
												</label> <label> <input class="ml-6" type="checkbox"
														name="PREGNANCY_WEEK"> 28주 이상
												</label> )</td>
											</tr>
											<tr>
												<th scope="col" class="text-dark bg-light  font-weight-bold"
												...
												<td class="form-control"><input type="text"
													class="form-control" id="ACCOUNT_HOLDER_NM"
													name="ACCOUNT_HOLDER_NM" placeholder="예금주"></td>
											</tr>
											<tr>
												<th scope="col" class="text-dark bg-light  font-weight-bold"
													style="vertical-align: middle;">계좌번호</th>
												<td colspan="3"><input type="text" class="form-control"
													id="ACCOUNT_NO" name="ACCOUNT_NO" placeholder="계좌번호">
												</td>
											</tr>
										</tbody>
									</table>
										...
										<tbody>
											<tr>
												...
												<td colspan="3"><label> <input class="ml-2"
														type="radio" name="INCOME_ACT_1_YN"> 고용보험 피보험자이나
														180일 요건 미충족으로 고용보험의 ‘출산전후휴가급여’를 지급받지 못하는 자(출산일 전일까지 30일 이상
														피보험자격을 유지하고 있어야 함)
												</label><br> <label> <input class="ml-2" type="radio"
														name="INCOME_ACT_1_YN"> 고용보험법 적용 제외 사업의 근로자이거나
														고용보험법 적용 제외자
												</label><br> <label> <input class="ml-2" type="radio"
														name="INCOME_ACT_1_YN"> 고용보험 미성립사업장 소속 고용보험 미가입
														근로자
												</label><br></td>
											</tr>
											<tr>
												...
												<td colspan="3"><label> <input class="ml-2"
														type="radio" name="INCOME_ACT_2_YN"> 전전년도~출산년도 사업에
														대한 세금신고 사실이 있는 자
												</label><br> <label> <input class="ml-2" type="radio"
														name="INCOME_ACT_2_YN"> 전전년도~출산년도 사업에 대한 세금신고 사실이
														없는 자
												</label><br></td>
											</tr>
											<tr>
												<th>기타 소득활동하는 자</th>
												<td colspan="3"><label> <input class="ml-2"
														type="radio" name="INCOME_ACT_3_YN"> 사업자등록증 없는
														특수형태근로자, 프리랜서 등
												</label></td>
											</tr>
										</tbody>
										...
										<tbody>
											<tr>
												<td colspan="4"><input type="text" class="form-control"
													id="APPL_PERIOD_EXT_REASON" name="APPL_PERIOD_EXT_REASON">
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="d-flex justify-content-between mt-4">
							<a href="${pageContext.request.contextPath}/approval24"
