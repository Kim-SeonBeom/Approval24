			...
			<div id="content">
				...
				<div class="container-fluid mb-4">
					...
					<form id="submitForm" method="post" action="${pageContext.request.contextPath}/complain/category/mt2/${detail.complainId}">
								...
								<div class="table-responsive">
									<table class="table table-bordered mb-0" width="100%">
										...
										<tbody>
											<tr>
												<th>출산(유산/사산)일</th>
												<td><input type="date" class="form-control" name="birthdate" value="<fmt:formatDate value='${detail.birthdate}' pattern='yyyy-MM-dd'/>"></td>
												<th>영아의 주민등록번호</th>
												<td><input type="text" id="babyResiNoFront" name="babyResiNoFront" maxlength="6" inputmode="numeric" pattern="[0-9]*" placeholder="생년월일 6자리" style="width: 40%; display: inline-block;" class="form-control" value="<c:out value='${detail.babyResiNoFront}'/>"> <span class="mx-1">-</span> <input type="text" name="babyResiNoBack" id="babyResiNoBack" maxlength="7" inputmode="numeric" pattern="[0-9]*" placeholder="뒤 7자리" style="width: 50%; display: inline-block;"
													class="form-control" value="<c:out value='${detail.babyResiNoBack}'/>"></td>
											</tr>
										</tbody>
									</table>
								</div>
											...
											<tr>
												...
												<td class="align-middle">
													<div class="form-check form-check-inline">
														<input class="form-check-input" type="radio" name="cohabitYn" id="cohabitYnY" value="Y" <c:if test="${detail.cohabitYn eq 'Y'}">checked</c:if>> <label class="form-check-label" for="cohabitYnY">예</label>
													</div>
													<div class="form-check form-check-inline ml-3">
														<input class="form-check-input" type="radio" name="cohabitYn" id="cohabitYnN" value="N" <c:if test="${detail.cohabitYn ne 'Y'}">checked</c:if>> <label class="form-check-label" for="cohabitYnN">아니오</label>
													</div>
												</td>
												<th>친족여부</th>
												<td>
									...
									<table class="table table-bordered mb-0" style="width: 100%">
										...
										<tbody>
											<tr>
												...
												<th>사업장의 고용보험관리번호</th>
												<td><input type="text" class="form-control" name="empInsurMngNo" value="<c:out value='${detail.empInsurMngNo}'/>"></td>
											</tr>
											<tr>
											...
											<tr>
												<th>사업자등록번호</th>
												<td><input type="text" class="form-control" name="bizRegNo" value="<c:out value='${detail.bizRegNo}'/>"></td>
												<th>법인등록번호</th>
												<td><input type="text" class="form-control" name="corpRegNo" value="<c:out value='${detail.corpRegNo}'/>"></td>
											</tr>
											<tr>
												<th>자영업자고용보험 가입여부</th>
												<td colspan="3">
									...
									<table class="table table-bordered mb-0" style="width: 100%">
										...
										<tbody>
											<tr>
												...
												<td class="align-middle">
													<div class="form-check form-check-inline ml-3">
														<input class="form-check-input" type="radio" name="benefitType" id="benefitType_1" value="출산급여" <c:if test="${detail.benefitType eq '출산급여'}">checked</c:if>> <label class="form-check-label" for="benefitType_1">출산급여</label>
													</div>
													<div class="form-check form-check-inline ml-3">
														<input class="form-check-input" type="radio" name="benefitType" id="benefitType_2" value="유산/사산급여" <c:if test="${detail.benefitType ne '출산급여'}">checked</c:if>> <label class="form-check-label" for="benefitType_2">유산/사산급여</label>
													</div>
												</td>
												<th>임신기간</th>
												<td>
											...
											<tr>
												...
												<td class="form-control"><input type="text" class="form-control" id="accountHolderNm" name="accountHolderNm" placeholder="예금주" value="<c:out value='${detail.accountHolderNm}'/>"></td>
											</tr>
											<tr>
												<th scope="col" class="text-dark bg-light  font-weight-bold" style="vertical-align: middle;">계좌번호</th>
												<td colspan="3"><input type="text" class="form-control" id="accountNo" name="accountNo" placeholder="계좌번호" value="<c:out value='${detail.accountNo}'/>"></td>
											</tr>
										</tbody>
									</table>
								</div>
						...
						<div class="card shadow mb-4">
							<div class="card-header py-3 d-flex align-items-center">
								<h6 class="m-0 font-weight-bold text-primary">출산(유산･사산)일 현재 소득활동 여부(택1)</h6>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table class="table table-bordered mb-0" style="width: 100%">
										...
										<tbody>
											<tr>
												...
												<td colspan="3">
													...
													<div class="form-check form-check-inline ml-3">
														<input class="form-check-input" type="radio" name="incomeAct" id="incomeAct_2" value="incomeType2" <c:if test="${detail.incomeAct eq 'incomeType2'}">checked</c:if>> <label class="form-check-label" for="incomeAct_2">고용보험법 적용 제외 사업의 근로자이거나 고용보험법 적용 제외자</label>
													</div> <br>
													<div class="form-check form-check-inline ml-3">
														<input class="form-check-input" type="radio" name="incomeAct" id="incomeAct_3" value="incomeType3" <c:if test="${detail.incomeAct eq 'incomeType3'}">checked</c:if>> <label class="form-check-label" for="incomeAct_3">고용보험 미성립사업장 소속 고용보험 미가입 근로자</label>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td colspan="3">
													...
													<div class="form-check form-check-inline ml-3">
														<input class="form-check-input" type="radio" name="incomeAct" id="incomeAct_5" value="incomeType5" <c:if test="${detail.incomeAct eq 'incomeType5'}">checked</c:if>> <label class="form-check-label" for="incomeAct_5">전전년도~출산년도 사업에 대한 세금신고 사실이 없는 자</label>
													</div>
												</td>
											</tr>
											<tr>
						...
						<div class="card shadow mb-4">
							<div class="card-header py-3 d-flex align-items-center">
								<h6 class="m-0 font-weight-bold text-primary">신청기간 연장사유(출산 또는 유산･사산일로부터 1년을 경과하여 신청하는 경우에만 기재)</h6>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table class="table table-bordered mb-0" style="width: 100%">
										...
										<tbody>
											<tr>
												<td colspan="4"><input type="text" class="form-control" id="applPeriodExtReason" name="applPeriodExtReason" value="<c:out value='${detail.applPeriodExtReason}'/>"></td>
											</tr>
										</tbody>
									</table>
								</div>
