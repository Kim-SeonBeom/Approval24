				...
				<tbody>
					<tr>
						...
						<td><input type="text" class="form-control"
							name="complainuserName" value="<c:out value='${userInfo.complainuserName}'/>" required></td>
						<th>주민등록번호</th>
						<td><input type="text" class="form-control" id="complainuserResiNoFront" name="complainuserResiNoFront"
							maxlength="6"  pattern="[0-9]*" 
							placeholder="생년월일 6자리" style="width: 40%; display: inline-block;" value="<c:out value='${userInfo.complainuserResiNoFront}'/>" required>
							...
							pattern="[0-9]*"  value="<c:out value='${userInfo.complainuserResiNoBack}'/>" placeholder="뒤 7자리"
						...
						<td colspan="3">
							<div class="d-flex mb-2">
								<input type="text" class="form-control form-postal-code mr-2"
									...
									value="<c:out value='${userInfo.complainuserPost}'/>">
							...
							name="complainuserAddress" id="complainuserAddress" value="<c:out value='${userInfo.complainuserAddress}'/>" readonly>
							<input type="text" class="form-control"
							placeholder="상세 주소 (건물명, 동/호수 등)" name="complainuserAddressDetail"
							id="complainuserAddressDetail" value="<c:out value='${userInfo.complainuserAddressDetail}'/>" required>
						</td>
					</tr>
					<tr>
						<th>전화번호</th>
						<td><input type="tel" class="form-control"
							name="complainuserTel" value="<c:out value='${userInfo.complainuserTel}'/>"></td>
						<th>휴대전화번호</th>
						<td><input type="tel" class="form-control"
							name="complainuserPhone" value="<c:out value='${userInfo.complainuserPhone}'/>" required></td>

					</tr>
					<tr>
						<th>이메일</th>
						<td colspan="3"><input type="email" class="form-control"
							name="complainuserEmail" value="<c:out value='${userInfo.complainuserEmail}'/>" ></td>
					</tr>
				</tbody>
			</table>
		</div>
