											...
											<tr>
												...
												<td colspan="3">
													...
													<div class="form-check form-check-inline">
														...
														<label class="form-check-label" for="participantType">②
									...
									<table class="table table-bordered mb-0" width="100%">
										...
										<tbody>
											...
											<tr>
												...
												<td><input type="text" class="form-control"
													name="major" id="major"
													value="<c:out value='${detail.major}'/>"></td>
												<th>상태</th>
												<td><select name="studentStatus" id="studentStatus"
													class="form-control">
														<option value="" disabled selected>선택하세요</option>
														<option value="재학"
