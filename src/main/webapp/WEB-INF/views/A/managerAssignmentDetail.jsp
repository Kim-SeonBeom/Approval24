			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-3">
						<h1 class="h3 mb-0 text-gray-800">담당자배정 상세</h1>
					</div>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<form id="managerAssignmentForm" action="/approval24/MA/update" method="post">
                                ...
                                <input type="hidden" name="complainCategoryId" value="${MAInfo.complainCategoryId}">
                                <input type="hidden" name="accountId" value="${MAInfo.accountId}">
