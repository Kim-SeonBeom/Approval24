				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
					  <div class="card-header py-3 d-flex justify-content-between align-items-center">
					    ...
					    <button class="btn btn-primary btn-sm" type="submit" form="instFilterForm">검색</button>
					  </div>
					
					  <div class="card-body">
					    <form id="instFilterForm" action="${pageContext.request.contextPath}/insts" method="get">
					      ...
					      <!-- 4) 대표자명 -->
					      <div class="form-group row align-items-center mb-3">
					        <label for="instHeadName" class="col-sm-2 col-form-label font-weight-bold text-center">대표자명</label>
					        <div class="col-sm-10">
					          <input type="text" class="form-control w-25" id="instHeadName" name="instHeadName"
					                 value="${filter.instHeadName}" placeholder="대표자명 입력">
					        </div>
					      </div>
					
					      <!-- 5) 주소 -->
					      <div class="form-group row align-items-center mb-3">
					        <label for="instAddress" class="col-sm-2 col-form-label font-weight-bold text-center">주소</label>
					        <div class="col-sm-10">
					          <input type="text" class="form-control w-50" id="instAddress" name="instAddress"
					                 value="${filter.instAddress}" placeholder="주소">
					        </div>
					      </div>
					...
					<div class="card shadow mb-4">
					  <div class="card-header py-3 d-flex align-items-center justify-content-between">
					    <h6 class="m-0 font-weight-bold text-primary">기관 목록</h6>
					    <a class="btn btn-primary btn-sm" id="instsCreate"
					       href="${pageContext.request.contextPath}/insts/new"
					       style="font-size:1rem; padding:0.25rem 0.75rem;">+ 기관 등록</a>
					  </div>
					          ...
					          <li class="page-item ${curr <= 1 ? 'disabled' : ''}">
					            <a class="page-link"
					               href="<c:url value='/insts'>
					                        ...
					                        <c:if test='${not empty filter.instHeadName}'><c:param name='instHeadName' value='${filter.instHeadName}'/></c:if>
					                        <c:if test='${not empty filter.instAddress}'><c:param name='instAddress' value='${filter.instAddress}'/></c:if>
					                    </c:url>">이전</a>
					          </li>
