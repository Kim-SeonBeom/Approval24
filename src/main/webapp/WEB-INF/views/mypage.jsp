						...
						<div class="card-body">
							<div class="row align-items-start">
								<div class="col-lg-6 col-md-4 col-12 d-flex  justify-content-center align-items-center mb-4">
									<img src="${pageContext.request.contextPath}/resources/assets/img/test_human.png" id="mypageProfileImage" class="rounded-circle me-3" alt="Profile Image Preview" style="width: 300px; height: 400px;">
								</div>
								<!-- 개인 정보들 -->
